...
static void _stack_array_test(void) {
    ...
    std::cout << "½«ÒªÒÆ³ý" << stack_array_top(s_array) << std::endl;
    std::cout << "ÒÆ³ý" << stack_array_pop(s_array) << std::endl;
    stack_array_print(s_array);
...
static void _stack_list_test(void) {
    ...
    std::cout << "½«ÒªÒÆ³ý" << stack_list_top(s_list) << std::endl;
    std::cout << "ÒÆ³ý" << stack_list_pop(s_list) << std::endl;
    stack_list_print(s_list);
